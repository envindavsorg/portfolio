...
export const buildRegistry = async (registryInput: Registry) => {
...
export const Index: Record<string, any> = {`;
  for (const item of registryInput.items) {
  ...
  await fs.writeFile(
    path.join(REGISTRY_PATH, "index.tsx"),
    index,
    "utf-8"
  );
};
