    ...
    >
      ...
      <motion.path
        ...
        transition={{
          ...
          duration: calc(0.8),
          ease: "easeInOut",
          opacity: { delay: calc(0.9), duration: 0.5 },
        }}
      />
      ...
      <motion.path
        ...
        transition={{
          ...
          duration: calc(0.4),
          ease: "easeInOut",
          opacity: { delay: calc(1.6), duration: 0.3 },
        }}
      />
      ...
      <motion.path
        ...
        transition={{
          ...
          duration: calc(0.8),
          ease: "easeInOut",
          opacity: { delay: calc(1.9), duration: 0.5 },
        }}
      />
      ...
      <motion.path
        ...
        transition={{
          ...
          duration: calc(1.2),
          ease: "easeInOut",
          opacity: { delay: calc(2.6), duration: 0.6 },
        }}
      />
      ...
      <motion.path
        ...
        transition={{
          ...
          duration: calc(0.7),
          ease: "easeInOut",
          opacity: { delay: calc(3.7), duration: 0.4 },
        }}
      />
      ...
      <motion.path
        ...
        transition={{
          ...
          duration: calc(0.6),
          ease: "easeInOut",
          opacity: { delay: calc(4.3), duration: 0.4 },
        }}
      />
