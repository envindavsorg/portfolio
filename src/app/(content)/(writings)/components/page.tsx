    ...
    <div className="screen-line-after min-h-svh">
      ...
      <PanelContent className="screen-line-after screen-line-before">
        <Prose>
          ...
          <i>
            collection complète de composants et hooks React optimisés
          </i>
        ...
        <Prose>
          ...
          <span>Server Actions</span>. Intégration transparente avec
          les dernières fonctionnalités de <i>Next.js 16</i> --
        </Prose>
      </PanelContent>
