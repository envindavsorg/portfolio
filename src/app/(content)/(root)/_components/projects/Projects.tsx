  ...
  return (
    <Panel>
      ...
      <PanelContent>
        ...
        <Prose>
          -- du <span>développement</span> d'applications web modernes
          aux
          <span>expérimentations techniques</span>, chaque projet
          représente un défi relevé et des compétences acquises --
        </Prose>
        <Prose>
          -- certains sont en production, d'autres sont des
          side-projects qui me permettent d'explorer de nouvelles
          technologies --
        </Prose>
      </PanelContent>
