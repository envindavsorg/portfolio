  ...
  <Panel>
    ...
    <PanelContent>
      ...
      <Prose>
        ...
        <i>mes compétences techniques</i> et démontrent mon engagement
        envers <span>l'excellence</span> et{" "}
        <span>l'apprentissage</span> continu dans le développement web
        moderne --
      </Prose>
    </PanelContent>
