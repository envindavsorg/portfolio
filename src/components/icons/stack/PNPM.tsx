...
export const PNPMIcon = (props: SVGProps<SVGSVGElement>): React.JSX.Element => (
	...
	>
		...
		<g>
			...
			<g>
				<use className="fill-foreground" fillOpacity={1} opacity={1} xlinkHref="#b1Lv79ypvm" />
			</g>
			<g>
				<use className="fill-foreground" fillOpacity={1} opacity={1} xlinkHref="#hy1IZWwLX" />
			</g>
			<g>
				<use className="fill-foreground" fillOpacity={1} opacity={1} xlinkHref="#akQfjxQes" />
			</g>
			<g>
				<use className="fill-foreground" fillOpacity={1} opacity={1} xlinkHref="#bdSrwE5pk" />
			</g>
		</g>
	</svg>
);
