...
const Table = ({ className, ...props }: React.ComponentProps<'table'>): React.JSX.Element => (
	<div className="not-prose my-6 w-full overflow-y-auto rounded-lg border" data-slot="table-container">
		<table
...
const TableHeader = ({ className, ...props }: React.ComponentProps<'thead'>): React.JSX.Element => (
	<thead className={cn('[&_tr]:border-b', className)} data-slot="table-header" {...props} />
);

const TableBody = ({ className, ...props }: React.ComponentProps<'tbody'>): React.JSX.Element => (
	<tbody className={cn('[&_tr:last-child]:border-0', className)} data-slot="table-body" {...props} />
);

const TableRow = ({ className, ...props }: React.ComponentProps<'tr'>): React.JSX.Element => (
	<tr
...
const TableCell = ({ className, ...props }: React.ComponentProps<'td'>): React.JSX.Element => (
