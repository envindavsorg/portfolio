...
export const ContributionGraph = ({
	...
	className,
	...props
}: ContributionGraphProps): React.JSX.Element | null => {
	...
	return (
		...
		>
			<svg
				...
				width={width}
			>
				<title>Graphique de contributions GitHub</title>
				{!hideMonthLabels && (
...
export const ContributionGraphFooter = ({
	className,
	...props
}: ContributionGraphFooterProps): React.JSX.Element => (
	<div
		className={cn(
...
export const ContributionGraphTotalCount = ({
	...
	children,
	...props
}: ContributionGraphTotalCountProps): React.JSX.Element => {
...
export const ContributionGraphLegend = ({
	...
	children,
	...props
}: ContributionGraphLegendProps): React.JSX.Element => {
