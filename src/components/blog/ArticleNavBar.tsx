    ...
    <>
      ...
      <div className="flex items-center px-2 py-2 sm:justify-between sm:px-4">
        <Button
          ...
          onMouseEnter={() =>
            iconArrowLeftRef.current?.startAnimation()
          }
          onMouseLeave={() =>
            iconArrowLeftRef.current?.stopAnimation()
          }
          variant="link"
        >
          <Link
        ...
        <div className="flex items-center gap-2 max-sm:flex-1 max-sm:justify-end">
          ...
          <ShareMenu
            url={`/${item.metadata.category}/${item.slug}`}
          />
          ...
          {next && (
            <Button
              asChild
              onMouseEnter={() =>
                iconArrowRightRef.current?.startAnimation()
              }
              onMouseLeave={() =>
                iconArrowRightRef.current?.stopAnimation()
              }
              size="icon"
              variant="outline"
            >
