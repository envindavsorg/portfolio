...
import { DOCUMENTS_LINKS, MAIN_LINKS, MENU_LINKS } from './content';
...
export const CommandContent = ({ posts = [] }: CommandContentProps): React.JSX.Element | null => {
				...
				<Dialog onOpenChange={setOpen} open={open}>
					...
					>
						<VisuallyHidden>
							...
							<DialogDescription>Utilisez la barre de recherche ...</DialogDescription>
						</VisuallyHidden>
			...
			<Drawer onOpenChange={setOpen} open={open}>
				<DrawerContent className="overflow-hidden bg-popover p-0 backdrop-blur-lg supports-backdrop-filter:bg-popover/90">
					<VisuallyHidden>
						...
						<DrawerDescription>Utilisez la barre de recherche ...</DrawerDescription>
					</VisuallyHidden>
