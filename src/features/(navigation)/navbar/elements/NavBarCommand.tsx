...
import { CommandItemProps, CommandKind } from "./types";
...
const CommandFooter = memo(({ kindMap }: CommandFooterProps) => {
  ...
  return (
    <div className="hidden sm:flex h-12 items-center justify-end gap-x-4 border-input border-t px-4">
      <KbdGroup>
      ...
      <Wrapper onOpenChange={handleOpenChange} open={open}>
        ...
        >
          ...
          <Command>
            ...
            <CommandList className="max-sm:py-2 max-sm:border-t max-sm:border-input">
              <CommandEmpty />
