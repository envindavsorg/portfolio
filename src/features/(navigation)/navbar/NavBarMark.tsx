...
const StaticMark = forwardRef<SVGSVGElement, React.ComponentProps<'svg'>>((props, ref) => (
	<svg fill="none" height="26" ref={ref} viewBox="0 0 39 26" width="39" xmlns="http://www.w3.org/2000/svg" {...props}>
		<path
