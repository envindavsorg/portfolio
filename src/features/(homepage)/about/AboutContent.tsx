...
const AboutContent = memo(
	({ expanded }: AboutContentProps): React.JSX.Element => (
		<PanelContent>
			<AboutPointer />
			...
			{expanded && (
				<>
					<TextAnimate animation="slideUp" as="p" by="word" className="mt-3" delay={0.6}>
						...
						adopté la logique modulaire de React et la robustesse de TypeScript, qui ont remplacé la manipulation
						manuelle du DOM et le débogage fastidieux par une architecture fiable. L'ajout de Next.js et Tailwind CSS a
						ensuite décuplé ma productivité : fini les configurations lourdes et le CSS ingérable.
					</TextAnimate>
