...
export const FrenchFlag = memo((props: React.SVGProps<SVGSVGElement>) => (
	<svg height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg" {...props}>
		...
		<path d="M25,4h6V28h-6c-2.208,0-4-1.792-4-4V8c0-2.208,1.792-4,4-4Z" fill="#be2a2c" transform="rotate(180 26 16)" />
		<path
