...
type HelloEffectProps = ComponentProps<typeof motion.svg> & {
  speed?: number;
  strokeWidth?: number;
  ...
  return (
    ...
    >
      <motion.path
        ...
        d="M9.19214 167.053C36.7393 151.739 61.8409 132.048 90.3191 98.5294C109.703 75.6487 120.125 49.5227 120.622 31.5025C120.87 18.1035 114.336 7.93871 102.259 7.93871C88.8598 7.93871 80.4231 18.1035 75.2122 41.4362C69.505 67.0792 65.2866 96.5035 54.6166 190.856"
        initial={capture ? false : initialProps}
