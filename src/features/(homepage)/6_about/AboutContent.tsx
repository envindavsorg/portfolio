...
const AboutContent = memo(({ expanded }: AboutContentProps) => (
	<PanelContent>
		...
		>
			...
			complexité de JavaScript. J'ai passé des semaines à décortiquer la logique
			des Promises et de l'asynchrone jusqu'au déclic. Cette courbe
			d'apprentissage m'a enseigné une leçon précieuse : chaque erreur est une
			opportunité de comprendre le "pourquoi" derrière le "comment". C'est cette
			gratification de voir une idée abstraite devenir une réalité interactive
			qui me motive chaque jour.
		</TextAnimate>
		...
		{expanded && (
			<>
				...
				>
					...
					modulaire de React et la robustesse de TypeScript, qui ont remplacé la
					manipulation manuelle du DOM et le débogage fastidieux par une
