...
const CurriculumVitaeContent = (): React.JSX.Element => (
	<PanelContent className="*:prose *:prose-sm *:prose-zinc dark:*:prose-invert space-y-2 *:max-w-none *:font-mono *:text-foreground">
		...
		<TextAnimate animation="fadeIn" as="p" by="word" delay={0.8}>
			Pour recevoir une copie actualisée directement dans votre boîte e-mail, cliquez sur le bouton
			ci-dessous. Je serai ravi d'échanger avec vous sur d'éventuelles opportunités de
			collaboration.
		</TextAnimate>
	</PanelContent>
);

CurriculumVitaeContent.displayName = 'CVContent';
