...
export const Experiences = () => {
	...
	return (
		<Panel>
			...
			<PanelContent>
				<Prose>
					-- retour sur <i>mon parcours professionnel</i> et les expériences qui
					m'ont permis de grandir en tant que <span>développeur Front-End</span>
					, puis <span>Full-Stack</span> --
				</Prose>
				<Prose>
