...
**TypeScript** est arrivé peu après. J'étais sceptique au départ — encore un outil à intégrer dans la chaîne. Puis j'ai perdu trois heures à traquer une faute de frappe dans un nom de propriété. L'argument était trouvé.
