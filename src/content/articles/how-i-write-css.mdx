...
> [!WARNING]
> `@apply` casse aussi la lecture : la classe ne dit plus ce qu'elle fait, et il
> faut ouvrir la feuille de style pour le savoir. C'est exactement ce que
> Tailwind était censé supprimer.
